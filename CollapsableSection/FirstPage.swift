...
class FirstPage: UIViewController,ExpandHeaderView{
    func Toggle(header: Expand, section: Int) {
        ...
        firstPageTableView.reloadSections([section], with: .automatic)
    ...
    override func viewDidLoad() {
        ...
        // Resgistering the Class of TableViewCell
        
        let cellNib = UINib(nibName: "TableViewCell", bundle: nil)
        firstPageTableView.register(cellNib, forCellReuseIdentifier:"CellIdentifier")
